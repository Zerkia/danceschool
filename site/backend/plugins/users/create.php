					...
					if ($stmt->execute()) {
						if ($stmt->rowCount() > 0) {
							...
							if (!sqlQueryPrepared('
								...
								INSERT INTO `brugere`(`email`, `adgangskode`, `fk_profil`, `fk_brugerrolle`) 
								...
								',array(
                                    ...
                                    echo '<h4>Bruger oprettet!</h3>';
                                    echo '<h4><a href="?side=logind">Klik her</a> for at komme til login siden!</h3>';
								}
						}
					}
					else {
